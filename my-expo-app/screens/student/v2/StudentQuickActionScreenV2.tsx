...
const GRID_ROWS: { label: string; screen: string; image: any; color: string; tag: string; subtitle: string; fullWidth?: boolean }[][] = [
  [
    { label: 'My Attendance', screen: 'attendance', image: require('../../../assets/icons/exam-results.png'), color: '#10B981', tag: 'Report', subtitle: 'View attendance report' },
    { label: 'Kids Activity', screen: 'activityFeed', image: require('../../../assets/icons/player.png'), color: '#F59E0B', tag: 'Feed', subtitle: 'View school activities' },
  ],
  [
    { label: 'Timetable', screen: 'timetable', image: require('../../../assets/icons/calendar.png'), color: '#6366F1', tag: 'Plans', subtitle: 'Daily school schedule' },
    { label: 'Live Camera', screen: 'liveCamera', image: require('../../../assets/icons/cctv-camera.png'), color: '#3B82F6', tag: 'Live', subtitle: 'View classroom live feed' },
  ],
  [
    { label: 'My Fees', screen: 'myFees', image: require('../../../assets/icons/wallet.png'), color: '#8B5CF6', tag: 'Payments', subtitle: 'View fee details & payments' },
    { label: 'Emergency Contact', screen: 'emergencyContact', image: require('../../../assets/icons/family.png'), color: '#EF4444', tag: 'Call', subtitle: 'Call guardians quickly' },
  ],
  [
    { label: 'Messages', screen: 'nannyChat', image: require('../../../assets/icons/discussion (1).png'), color: '#06B6D4', tag: 'Chat', subtitle: 'Talk to your nanny', fullWidth: true },
  ],
];
...
export default function StudentQuickActionScreenV2({ navigation }: Props) {
  const { user } = useAuth();
        ...
        <View style={{ paddingTop: Math.max(insets.top, 56), paddingHorizontal: 20 }}>
          ...
          <View style={{ height: 52, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            <View style={{ flex: 1, paddingRight: 12 }}>
              <Text style={{ fontSize: 12, fontWeight: '400', color: TEXT_MUTED }}>Student Access</Text>
            ...
            >
              {user?.avatar ? (
                ...
                <Image
                  source={require('../../../assets/Avatar/kids.png')}
          ...
          {/* ── Section title ── */}
          <Text style={{ fontSize: 18, fontWeight: '600', color: TEXT_PRIMARY }}>Student Controls</Text>
