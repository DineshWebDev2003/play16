...
import { View, Text, ScrollView, TouchableOpacity, Alert, Image, Linking, RefreshControl, StyleSheet, Dimensions } from 'react-native';
...
const MENU_ICONS: Record<string, any> = {
  ...
  guardian: require('../../assets/icons/team.png'),
...
export default function StudentAccountScreen({ navigation }: Props) {
  ...
  const menuItems = [
    { id: 'profile', title: 'My Profile', subtitle: 'View and update your profile', image: 'profile', color: '#F59E0B', bg: 'rgba(245, 158, 11, 0.12)' },
    { id: 'guardian', title: 'Guardian Contacts', subtitle: 'Emergency contact information', image: 'guardian', color: '#10B981', bg: 'rgba(16, 185, 129, 0.12)' },
    { id: 'notifications', title: 'Notifications', subtitle: 'Activity and announcement alerts', image: 'notifications', color: '#EC4899', bg: 'rgba(236, 72, 153, 0.12)' },
    { id: 'support', title: 'Support & Help', subtitle: 'Get help and contact support', image: 'support', color: '#10B981', bg: 'rgba(16, 185, 129, 0.12)' },
    { id: 'about', title: 'About Us', subtitle: 'Visit our school website', image: 'about', color: '#EC4899', bg: 'rgba(236, 72, 153, 0.12)' },
          ...
          <TouchableOpacity activeOpacity={0.9} onPress={() => navigation.navigate('profileSettings')} style={glassCard}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
              ...
              <View style={{ backgroundColor: 'rgba(16,185,129,0.12)', paddingHorizontal: 12, paddingVertical: 5, borderRadius: 100, flexDirection: 'row', alignItems: 'center' }}>
                <MaterialCommunityIcons name="at" size={11} color={ACCENT} />
                <Text style={{ color: ACCENT, fontSize: 9, fontWeight: '900', textTransform: 'uppercase', marginLeft: 4 }} numberOfLines={1}>{user?.username || 'user_id'}</Text>
              </View>
            </View>
            <View style={{ backgroundColor: 'rgba(247,249,246,0.9)', borderRadius: 18, padding: 14 }}>
              ...
              {user?.studentId && (
                <View style={{ backgroundColor: 'rgba(16,185,129,0.1)', alignSelf: 'flex-start', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, marginTop: 8, flexDirection: 'row', alignItems: 'center' }}>
                  <MaterialCommunityIcons name="card-account-details-star" size={12} color={ACCENT} />
