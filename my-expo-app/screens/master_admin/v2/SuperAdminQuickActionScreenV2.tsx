...
const GRID_ROWS: { label: string; screen: string; image: any; color: string; tag: string; fullWidth?: boolean }[][] = [
  [
    { label: 'Branches', screen: 'branchManagement', image: require('../../../assets/icons/kindergarten.png'), color: '#F59E0B', tag: 'Franchise' },
  ...
  [
    { label: 'User Management', screen: 'userMange', image: require('../../../assets/icons/team.png'), color: '#3B82F6', tag: 'Users' },
    { label: 'Announcements', screen: 'announcements', image: require('../../../assets/icons/megaphone.png'), color: '#F59E0B', tag: 'Alerts' },
  ],
  [
    { label: 'Attendance', screen: 'attendanceSelection', image: require('../../../assets/icons/exam-results.png'), color: '#EC4899', tag: 'Staff+Kids' },
    { label: 'Fees Management', screen: 'feesManagement', image: require('../../../assets/icons/maths.png'), color: '#10B981', tag: 'Fees' },
  ],
  [
    { label: 'Income/Expense', screen: 'incomeExpense', image: require('../../../assets/icons/maths.png'), color: '#6366F1', tag: 'Budget' },
    { label: 'Petty Cash', screen: 'pettyCash', image: require('../../../assets/icons/wallet.png'), color: '#10B981', tag: 'Cash' },
  ],
  [
    { label: 'Backup & Restore', screen: 'backup', image: require('../../../assets/icons/database.png'), color: '#14B8A6', tag: 'Vault' },
    { label: 'Student Info', screen: 'studentInfo', image: require('../../../assets/icons/student.png'), color: '#3B82F6', tag: 'Students' },
  ],
  [
    { label: 'Timetable', screen: 'timetable', image: require('../../../assets/icons/calendar.png'), color: '#6366F1', tag: 'Plans' },
    { label: 'Alumni', screen: 'alumni', image: require('../../../assets/icons/team.png'), color: '#7C3AED', tag: 'Alumni' },
  ],
  [
    { label: 'Kids Feed', screen: 'activityFeed', image: require('../../../assets/icons/painting.png'), color: '#F59E0B', tag: 'Moments' },
...
export default function SuperAdminQuickActionScreenV2({ navigation }: Props) {
  const { user } = useAuth();
        ...
        <View style={{ paddingTop: Math.max(insets.top, 56), paddingHorizontal: 20 }}>
          ...
          <View style={{ height: 52, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            <View style={{ flex: 1, paddingRight: 12 }}>
              <Text style={{ fontSize: 12, fontWeight: '400', color: '#7A8A82' }}>All Admin Access</Text>
            ...
            >
              {user?.avatar ? (
                ...
                <Image
                  source={require('../../../assets/Avatar/master-admin.png')}
          ...
          {/* ── Section title ── */}
          <Text style={{ fontSize: 18, fontWeight: '600', color: '#1F2D28' }}>Master Controls</Text>
