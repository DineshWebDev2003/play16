...
import { View, Text, ScrollView, TouchableOpacity, TextInput, Image, ActivityIndicator, Alert, Modal, Platform, StyleSheet, PanResponder, Dimensions } from 'react-native';
