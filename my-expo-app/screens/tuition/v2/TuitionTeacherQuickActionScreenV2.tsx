...
const GRID_ROWS: { label: string; screen: string; image: any; color: string; tag: string; subtitle: string; fullWidth?: boolean }[][] = [
  [
    { label: 'Post Homework', screen: 'postHomework', image: require('../../../assets/icons/note-book.png'), color: '#8B5CF6', tag: 'Assign', subtitle: 'Assign homework to students' },
    { label: 'Study Materials', screen: 'tuitionStudyMaterials', image: require('../../../assets/icons/education.png'), color: '#F97316', tag: 'Upload', subtitle: 'Upload & manage resources' },
  ],
  [
    { label: 'Post Progress', screen: 'tuitionPostProgress', image: require('../../../assets/icons/exam-results.png'), color: '#10B981', tag: 'Track', subtitle: 'Track student progress' },
    { label: 'Attendance', screen: 'tuitionAttendance', image: require('../../../assets/icons/calendar.png'), color: '#F59E0B', tag: 'Mark', subtitle: 'Mark daily attendance' },
  ],
  [
    { label: 'View Submissions', screen: 'viewSubmissions', image: require('../../../assets/icons/database.png'), color: '#3B82F6', tag: 'Review', subtitle: 'Review submitted work' },
    { label: 'Messages', screen: 'nannyChat', image: require('../../../assets/icons/discussion (1).png'), color: '#EC4899', tag: 'Chat', subtitle: 'Chat with nannies & admin' },
  ],
  [
    { label: 'Student List', screen: 'tuitionStudentList', image: require('../../../assets/icons/team.png'), color: '#14B8A6', tag: 'Directory', subtitle: 'Browse students by class' },
  ],
];
...
export default function TuitionTeacherQuickActionScreenV2({ navigation }: Props) {
        ...
        <View style={{ paddingTop: Math.max(insets.top, 56), paddingHorizontal: 20 }}>
          ...
          <View style={{ height: 52, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            <View style={{ flex: 1, paddingRight: 12 }}>
              <Text style={{ fontSize: 12, fontWeight: '400', color: TEXT_MUTED }}>Tuition Teacher Access</Text>
