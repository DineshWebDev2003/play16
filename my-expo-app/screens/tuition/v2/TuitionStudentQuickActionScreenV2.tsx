...
const GRID_ROWS: { label: string; screen: string; image: any; color: string; tag: string; subtitle: string; fullWidth?: boolean }[][] = [
  [
    { label: 'Homework', screen: 'homework', image: require('../../../assets/icons/note-book.png'), color: '#8B5CF6', tag: 'Tasks', subtitle: 'View & submit assignments' },
    { label: 'Study Materials', screen: 'tuitionStudyMaterials', image: require('../../../assets/icons/education.png'), color: '#F97316', tag: 'Resources', subtitle: 'View class resources' },
  ],
  [
    { label: 'My Progress', screen: 'tuitionMyProgress', image: require('../../../assets/icons/exam-results.png'), color: '#10B981', tag: 'Track', subtitle: 'Track performance' },
    { label: 'Attendance', screen: 'attendance', image: require('../../../assets/icons/calendar.png'), color: '#F59E0B', tag: 'Report', subtitle: 'View attendance record' },
  ],
  [
    { label: 'Messages', screen: 'nannyChat', image: require('../../../assets/icons/discussion (1).png'), color: '#EC4899', tag: 'Chat', subtitle: 'Chat with teachers & admin', fullWidth: true },
  ],
];
...
export default function TuitionStudentQuickActionScreenV2({ navigation }: Props) {
        ...
        <View style={{ paddingTop: Math.max(insets.top, 56), paddingHorizontal: 20 }}>
          ...
          <View style={{ height: 52, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            <View style={{ flex: 1, paddingRight: 12 }}>
              <Text style={{ fontSize: 12, fontWeight: '400', color: TEXT_MUTED }}>Tuition Student Access</Text>
          ...
          {/* ── Section title ── */}
          <Text style={{ fontSize: 18, fontWeight: '600', color: TEXT_PRIMARY }}>Tuition Student Controls</Text>
